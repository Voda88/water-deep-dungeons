	...
	match card_id:
		...
		"cure_light_wounds_card":
			return {
				...
				"target_scope": "hero",
				"phase": "combat",
				"description_lines": ["Restore 36 health to one hero", "Recharges after 3 opened rooms from a prepared prayer"],
				"heal_amount": 36.0,
				"door_interval": 3,
				"color": Color("c3ffb3"),
			}
		...
		"shield_bash_card":
			return {
				...
				"target_scope": "same_room",
				"phase": "combat",
				"description_lines": ["Slam enemies in a frontal arc", "Knocks enemies back", "Applies a 6s move/attack slow that gradually recovers"],
				"stamina_cost": 0.0,
				"base_damage": 12.0,
				"impact_radius": 138.0,
				"arc_angle_deg": 110.0,
