...
const GAME_MODULE_DEFS = preload("res://scripts/content/game_module_defs.gd")
...
const ENEMY_TYPE_WRAITH: String = "wraith"
...
const ROOM_OPEN_DUST_MAX: int = 7
...
const ENEMY_AI_BUDGET_DEFER_MIN: float = 0.04
const ENEMY_AI_BUDGET_DEFER_MAX: float = 0.09
...
var hero_bar: BoxContainer = null
