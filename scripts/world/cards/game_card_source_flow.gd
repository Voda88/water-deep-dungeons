...
static func build_hand_card_from_generator(game: Node, hero: Variant, generator: Dictionary, effect_summary: Dictionary) -> Dictionary:
	...
	var hand_card: Dictionary = {
		...
		"dot_damage_per_second": float(card_def.get("dot_damage_per_second", 0.0)),
		"channel_tick_interval": float(card_def.get("channel_tick_interval", 0.25)),
		...
		"haste_duration": float(card_def.get("haste_duration", 0.0)),
		"haste_move_speed_multiplier": float(card_def.get("haste_move_speed_multiplier", 1.0)),
		"haste_attack_speed_multiplier": float(card_def.get("haste_attack_speed_multiplier", 1.0)),
